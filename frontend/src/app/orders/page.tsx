          ...
          <div className="border-t pt-4">
            ...
            <div className="flex gap-4">
              <label className="flex items-center gap-1">
                <input type="radio" value="true" checked={wantsDrink === true} onChange={()=> setValue('wantsDrink', true)} />
                Sim
              </label>
              <label className="flex items-center gap-1">
                <input type="radio" value="false" checked={wantsDrink === false} onChange={()=> setValue('wantsDrink', false)}  />
                Não
              </label>
            </div>
